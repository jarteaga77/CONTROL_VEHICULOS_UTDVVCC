 ...
 * @author Jonathan
 */
public class JIFRutina extends javax.swing.JInternalFrame {

    
    private DefaultTableModel modelo;
    private ConexionBD conexion;
    private Rutina_mto rutina;
    ...
    public JIFRutina() {
        ...
        try {
            ...
            Logger.getLogger(JIFRutina.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        JD_guardar.setTitle("Registro Rutina");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro Rutina Mto."));
        ...
        JD_Modificar.setTitle("Modificación Tipo Mto.");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar Rutina Mto."));
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Rutina Mtos. --UTDVVCC--");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Rutinas de Mto."));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            rutina=new Rutina_mto();
            daoRutina=new DaoRutina();
            
            rutina.setDescripcion(nom);
            daoRutina.guardar(rutina);
            JOptionPane.showMessageDialog(this, "Se guardo con exito la Rutina de Mto.");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            String nomrutina=txt_eds1.getText();
            ...
            rutina.setRutina(id);
            rutina.setDescripcion(nomrutina);
            
            try {
                daoRutina.actualizar(id, nomrutina);
            } catch (Exception ex) {
                Logger.getLogger(JIFRutina.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            
            JOptionPane.showMessageDialog(this, "Se actualizo la Rutina");
            LimpiarTabla();
            consultarTodos();
