 ...
 * @author Jonathan
 */
public class JIFMarcaVehiculo extends javax.swing.JInternalFrame {
    ...
    public JIFMarcaVehiculo() {
        initComponents();
        
         modelo=new DefaultTableModel();
        
        modelo.addColumn("ID");
        modelo.addColumn("Marca Vehiculo");
        
        try {
            consultarTodos();
        } catch (SQLException ex) {
            Logger.getLogger(JIFMarcaVehiculo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        JD_guardar.setTitle("Registro de Marca Vehiculo / Equipo");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registrar Marca Vehiculo / Equpo"));
        ...
        JD_Modificar.setTitle("Modificar Marca Vehiculo / Equipo");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar Marca Vehiculo / Equipo"));
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Marca Vehiculo / Equipo --UTDVVCC--");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("MarcaVehiculo / Equipo "));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            String nom=txt_marca.getText();
            
            marca=new Marca();
            daoMarca=new DaoMarca();
            
            marca.setMarca(nom);
            daoMarca.guardar(marca);
            JOptionPane.showMessageDialog(this, "Se guardo con exito la Marca del vehiculo o Equipo");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
          }
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            conexion.executeUpdateQuery("UPDATE utilidades.marca_vehiculo SET descripcion='"+txt_marca1.getText()+"' WHERE id_marca="+txt_id1.getText()+"");
            JOptionPane.showMessageDialog(this, "Se actualizo la Marca");
    ...
    public void consultarTodos() throws SQLException
{
    ...
    ResultSet obj=conexion.executeQuery("SELECT id_marca,descripcion FROM utilidades.marca_vehiculo ORDER BY descripcion ASC");
