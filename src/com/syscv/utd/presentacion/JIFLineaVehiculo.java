...
import com.syscv.utd.dao.general.DaoLineVehiculo;
 ...
 * @author Jonathan
 */
public class JIFLineaVehiculo extends javax.swing.JInternalFrame {
    ...
    public JIFLineaVehiculo() {
        ...
        ResultSet obj=conexion.executeQuery("SELECT descripcion FROM utilidades.marca_vehiculo ORDER BY descripcion ASC");
        
        try {
            while (obj.next())
            {
                  {
            cb_marca.addItem(obj.getObject("descripcion"));
            cb_marca1.addItem(obj.getObject("descripcion"));
    ...
    private void initComponents() {
        ...
        JD_guardar.setTitle("Registro Linea de Vehiculo / Equipo");
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Linea Vehiculo / Equipo --UTDVVCC--");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Linea Vehiculo / Equipo "));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
       ...
       if(cb_marca.getSelectedItem()!= null)
       {
            String ma=cb_marca.getSelectedItem().toString();
            
            ResultSet obj=conexion.executeQuery("SELECT id_marca FROM utilidades.marca_vehiculo WHERE descripcion='"+ma+"'");
            
           
                  while (obj.next())
                  {
                      idmarca=obj.getInt("id_marca");
    ...
    try {
            ...
            if(cb_marca1.getSelectedItem()!= null)
       {
            String ma=cb_marca1.getSelectedItem().toString();
            ...
            conexion.executeUpdateQuery("UPDATE utilidades.linea_vehiculo SET descripcion='"+txt_descrep1.getText()+"', id_marca="+idmarca+" WHERE id_linea_vehi="+txt_id1.getText()+"");
        ...
        if(tb_consultar.isRowSelected(tb_consultar.getSelectedRow()))
            {
                ...
                ResultSet obj=conexion.executeQuery("SELECT descripcion FROM utilidades.marca_vehiculo WHERE descripcion='"+marca+"'");
    ...
    public void consultarTodos() throws SQLException
{
    ...
    ResultSet obj=conexion.executeQuery("SELECT li.id_linea_vehi,li.descripcion,m.descripcion AS marca FROM utilidades.linea_vehiculo li JOIN utilidades.marca_vehiculo m ON m.id_marca=li.id_marca ORDER BY descripcion ASC");
