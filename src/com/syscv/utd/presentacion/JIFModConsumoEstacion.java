 ...
 * @author Jonathan
 */
public class JIFModConsumoEstacion extends javax.swing.JInternalFrame {
    ...
    public JIFModConsumoEstacion() throws SQLException {
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        lb_estacion = new javax.swing.JLabel();
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle("Modificar Consumo x Estación  --UTDVVCC--");
        ...
        lb_estacion.setBackground(new java.awt.Color(51, 0, 51));
        lb_estacion.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lb_estacion.setForeground(new java.awt.Color(204, 153, 0));
        lb_estacion.setText("ESTACIÓN DE SERVICIO");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        detce.setId_ce(Integer.parseInt(txt_id.getText()));
...
//        }
    ...
    private void btn_terminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_terminarActionPerformed
        ...
        else 
        {
            ...
            try {
                ...
                Logger.getLogger(JIFModConsumoEstacion.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            reporte.ejecutarReporte2(Integer.parseInt(txt_id.getText()));
    ...
    private javax.swing.JLabel lb_estacion;
     ...
     public void eliminarRegistroTabla()
    {
     ...
     public void totalizador() throws SQLException
     {
         ...
         ResultSet obj=conexion.executeQuery("SELECT SUM(valor_total) AS total FROM consumo_combustible.det_con_eds WHERE id_ceds="+txt_id.getText()+"");
         ...
         conexion.executeUpdateQuery("UPDATE consumo_combustible.consumo_estacion SET total_pesos="+total+" WHERE id_ce="+txt_id.getText()+"");
         
         ResultSet obj1=conexion.executeQuery("SELECT (c.nombre_centro_costos ||' - '|| i.nombre_item_ccostos) AS centro, SUM (eds.valor_total)AS total FROM consumo_combustible.det_con_eds eds JOIN utilidades.vehiculos_equipos v ON v.id_vehiculo=eds.id_vehiculo JOIN utilidades.itemccostos i ON i.id_item_ccostos=v.id_item_ccostos JOIN utilidades.centrocostos c ON i.id_centrocostos=c.id_centrocostos WHERE eds.id_ceds="+txt_id.getText()+" GROUP BY centro");
         
         while (obj1.next())
         {
             centro=obj1.getString("centro");
             total_ccostos=obj1.getInt("total");
             conexion.executeUpdateQuery("INSERT INTO consumo_combustible.total_ccostos_ce (nom_ccosto,total_ccosto,id_ce)VALUES('"+centro+"', "+total_ccostos+", "+txt_id.getText()+")");        

         }
         
         conexion.executeUpdateQuery("UPDATE consumo_combustible.consumo_estacion SET fecha_mod='"+new Date()+"'WHERE id_ce="+txt_id.getText()+"");
     ...
     public void buscar(int id)
     {
         ...
         conexion=new ConexionBD();
                 ...
                 ResultSet obj1=conexion.executeQuery("SELECT eds.est_ser_desc AS estacion FROM consumo_combustible.consumo_estacion c JOIN utilidades.estaciones_servicio eds ON eds.est_ser_id=c.id_estacion  WHERE c.id_ce="+txt_id.getText()+" AND aprobado=false AND c.id_usuario="+idusuario+"");
         ...
         if(obj1.first())
       {
        ...
        while (obj1.next())
        {
            estacion=obj1.getString("estacion");
        }
        
        lb_estacion.setText(String.valueOf(estacion));
       ...
       {
         JOptionPane.showMessageDialog(null, "No se encuentra el ID "+ id+" de consumo por estacion ó el usuario no esta autorizado para la modificación.\n - El consumo de estación ya ha sido aprobado. ");
        ...
        public void eliminarUpdateTotales()
        {
            ...
            conexion.executeUpdateQuery("DELETE FROM consumo_combustible.total_ccostos_ce  WHERE id_ce="+txt_id.getText()+"");
            conexion.desconectar();
        }
