 ...
 * @author Jonathan
 */
public class JIFImprimirComparendo extends javax.swing.JInternalFrame {

 private DefaultTableModel modelo;
    
 private TableRowSorter trsFiltro;
 private ConexionBD conexion=new ConexionBD();
 private ReporteComparendo reporte;
 
    
    public JIFImprimirComparendo() {
        initComponents();
     ...
     try {
         ...
         Logger.getLogger(JIFImprimirComparendo.class.getName()).log(Level.SEVERE, null, ex);
     }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Imprimir y Visualizar Comparendo");

        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/syscv/utd/recursos/multa_1.png"))); // NOI18N
        ...
        cb_filtro.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ID", "Placa", "Vehiculo", "C.C Conductor", "Conductor", "N° Comparendo", "Estado" }));
   ...
   public void setCellRender(JTable table) {
    ...
    public void filtro() {
        ...
        if (cb_filtro.getSelectedItem() == "Vehiculo") {
         ...
         if (cb_filtro.getSelectedItem() == "C.C Conductor") {
            columnaABuscar = 3;
        }
