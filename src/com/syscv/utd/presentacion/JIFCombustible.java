...
import com.syscv.utd.dao.general.DaoCombustible;
 ...
 * @author Jonathan
 */
public class JIFCombustible extends javax.swing.JInternalFrame {

    
    private DefaultTableModel modelo;
    private ConexionBD conexion;
    private Combustible com;
    private DaoCombustible daoCom;
    
    public JIFCombustible() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(JIFCombustible.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        txt_com1 = new javax.swing.JTextField();
        ...
        JD_guardar.setTitle("Registro de Combustible");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registrar Combustible"));
        ...
        JD_Modificar.setTitle("Modificar Combustible");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificación Combustible"));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(txt_com1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(btn_guardar1)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Combustible --UTDVVCC--");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Combustible"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            String nom=txt_com.getText();
            
            com=new Combustible();
            daoCom=new DaoCombustible();
            
            com.setDescripcion(nom);
            daoCom.guardar(com);
            JOptionPane.showMessageDialog(this, "Se guardo con exito el Tipo de Combustible");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            conexion.executeUpdateQuery("UPDATE utilidades.tipo_combustible SET name_combustible='"+txt_com1.getText()+"' WHERE id_tipo_com="+txt_id1.getText()+"");
            JOptionPane.showMessageDialog(this, "Se actualizo el Tipo de Combustible");
    ...
    private javax.swing.JTextField txt_com1;
    ...
    public void consultarTodos() throws SQLException
{
    ...
    ResultSet obj=conexion.executeQuery("SELECT id_tipo_com,name_combustible FROM utilidades.tipo_combustible ORDER BY name_combustible ASC");
