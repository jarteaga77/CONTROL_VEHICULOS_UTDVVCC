...
import com.syscv.utd.DaosUtilidades.DaoRutina;
import com.syscv.utd.DaosUtilidades.DaoTipoMto;
 ...
 * @author Jonathan
 */
public class JIFTipoMto extends javax.swing.JInternalFrame {

    
    private DefaultTableModel modelo;
    private ConexionBD conexion;
    private Tipo_Mto tipo;
    private DaoTipoMto daoTipoMto;
    ...
    public JIFTipoMto() {
        ...
        try {
            ...
            Logger.getLogger(JIFTipoMto.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        txt_rutina = new javax.swing.JTextField();
        ...
        JD_guardar.setTitle("Registro Tipo Mto.");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro Tipo Mto."));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txt_rutina, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(btn_guardar)
        ...
        JD_Modificar.setTitle("Modificar Tipo Mto");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar Tipo Mto."));
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Tipo Mto. --UTDVVCC--");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Tipo Mto."));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            String nom=txt_rutina.getText();
            
            tipo=new Tipo_Mto();
            daoTipoMto=new DaoTipoMto();
            
            tipo.setDescripcion(nom);
            daoTipoMto.guardar(tipo);
            JOptionPane.showMessageDialog(this, "Se guardo con exito el Tipo de Mto.");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            String nomtipo=txt_eds1.getText();
            ...
            tipo.setId(id);
            tipo.setDescripcion(nomtipo);
            
            try {
                daoTipoMto.actualizar(tipo);
            } catch (Exception ex) {
                Logger.getLogger(JIFTipoMto.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            
            JOptionPane.showMessageDialog(this, "Se actualizo la Estación de servicio");
            LimpiarTabla();
            consultarTodos();
    ...
    private javax.swing.JTextField txt_rutina;
