 ...
 * @author Jonathan
 */
public class JIFImprimirTallerExterno extends javax.swing.JInternalFrame {

 private DefaultTableModel modelo;
    
 private TableRowSorter trsFiltro;
 private ConexionBD conexion=new ConexionBD();
 private ReporteTallerExterno reporte;
 
    
    public JIFImprimirTallerExterno() {
        initComponents();
     ...
     try {
         ...
         Logger.getLogger(JIFImprimirTallerExterno.class.getName()).log(Level.SEVERE, null, ex);
     }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Impresión Mto. Taller Externo --UTDVVCC--");
        ...
        jLabel1.setText("IMPRIMIR Taller Externo");
        ...
        cb_filtro.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ID", "Consecutivo", "NIT", "Proveedor", "Vehiculo / Equipo" }));
    ...
    private void btn_verActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_verActionPerformed
       ...
       int id;
        ...
        {
             reporte=new ReporteTallerExterno();
...
public void consultar() throws SQLException
{
  try
        ...
        ResultSet obj=conexion.executeQuery("SELECT mto.id_mto_externo,mto.consecutivo_vehiculo,mto.fecha_reg,p.nit, p.razon_social, (v.placa_identi ||''|| ' Tipo ' ||  t.descripcion || ' ' || m.descripcion  || '-'||l.descripcion) AS vehiculo FROM mantenimientos_mecanica.mtos_externos mto JOIN utilidades.talleres_externos_mec p ON mto.id_taller=p.id "
                + "JOIN utilidades.vehiculos_equipos v ON v.id_vehiculo=mto.id_vehiculo JOIN utilidades.linea_vehiculo l ON l.id_linea_vehi=v.id_linea "
                + "JOIN utilidades.marca_vehiculo m ON m.id_marca=l.id_marca JOIN utilidades.tipo_vehiculo t ON t.id_tipo_vehi=v.id_tipo_vehiculo ORDER BY mto.id_mto_externo DESC");
   ...
   public void setCellRender(JTable table) {
    ...
    public void filtro() {
        ...
        if (cb_filtro.getSelectedItem() == "NIT") {
            columnaABuscar = 3;
        }
        if (cb_filtro.getSelectedItem() == "Proveedor") {
            columnaABuscar = 4;
        }
