...
import com.syscv.utd.dao.general.DaoTipoDocumento;
...
public class JIFTipoDocumento extends javax.swing.JInternalFrame {
    ...
    private Tipo_Documentos_Vehi tipo;
    private DaoTipoDocumento daoTipo;
    ...
    public JIFTipoDocumento() {
        ...
        try {
            ...
            Logger.getLogger(JIFTipoDocumento.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        JD_guardar.setTitle("Registro Tipo de Documento Vehiculo");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Tipo Doc."));
        ...
        JD_Modificar.setTitle("Modificación Tipo Doc.");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar Tipo Doc."));
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Tipo de Documento Vehiculo / Equipo --UTDVVCC--");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Tipo documento Vehiculo / Equipo"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            tipo=new Tipo_Documentos_Vehi();
            daoTipo=new DaoTipoDocumento();
            
            tipo.setNombre_doc(nom);
            daoTipo.guardar(tipo);
            JOptionPane.showMessageDialog(this, "Se guardo con exito el Tipo de documento Vehiculo");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            tipo.setId_tipo_doc(id);
            tipo.setNombre_doc(edsnom);
            ...
            JOptionPane.showMessageDialog(this, "Se actualizo el Tipo de documento Vehiculo ");
            LimpiarTabla();
            consultarTodos();
