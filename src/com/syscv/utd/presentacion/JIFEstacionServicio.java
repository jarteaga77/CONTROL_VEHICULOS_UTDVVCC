...
import com.syscv.utd.dao.general.DaoEDS;
 ...
 * @author Jonathan
 */
public class JIFEstacionServicio extends javax.swing.JInternalFrame {

    
    private DefaultTableModel modelo;
    private ConexionBD conexion;
    private EstacionesServicio eds;
    private DaoEDS daoEDS;
    
    public JIFEstacionServicio() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(JIFEstacionServicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        JD_guardar.setTitle("Registro Estación de servicio");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro EDS"));
        ...
        JD_Modificar.setTitle("Modificación EDS");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar EDS"));
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Estaciones de Servicio --UTDVVCC--");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Estación de Servicio"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            String nom=txt_eds.getText();
            
            eds=new EstacionesServicio();
            daoEDS=new DaoEDS();
            
            eds.setNomEstacion(nom);
            daoEDS.guardar(eds);
            JOptionPane.showMessageDialog(this, "Se guardo con exito la Estación de servicio");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            String edsnom=txt_eds1.getText();
    ...
    public void consultarTodos() throws SQLException
{
    ...
    ResultSet obj=conexion.executeQuery("SELECT est_ser_id,est_ser_desc FROM utilidades.estaciones_servicio ORDER BY est_ser_desc ASC");
