...
import com.syscv.utd.reportes.ReporteComparendo;
import com.syscv.utd.reportes.ReportePagoComparendo;
 ...
 * @author Jonathan
 */
public class JIFImprimirPagoComparendo extends javax.swing.JInternalFrame {

 private DefaultTableModel modelo;
    
 private TableRowSorter trsFiltro;
 private ConexionBD conexion=new ConexionBD();
 private ReportePagoComparendo reporte;
 
    
    public JIFImprimirPagoComparendo() {
        initComponents();
        ...
        modelo.addColumn("N° Paz Y Salvo");
     ...
     try {
         ...
         Logger.getLogger(JIFImprimirPagoComparendo.class.getName()).log(Level.SEVERE, null, ex);
     }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Imprimir y Visualizar Pago Comparendo");

        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/syscv/utd/recursos/pagos_3.png"))); // NOI18N
        ...
        cb_filtro.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ID", "Conductor", "Placa" }));
    ...
    private void btn_verActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_verActionPerformed
       ...
       int id;
        ...
        {
             reporte=new ReportePagoComparendo();
...
public void consultar() throws SQLException
{
  try
        ...
        ResultSet obj=conexion.executeQuery("SELECT p.id_pago, p.fecha_pago,v.placa_identi, (c.nombre ||' '|| c.apellido) AS conductor, p.valor,p.paz_salvo_num\n" +
" FROM utilidades.pagos_comparendos p JOIN utilidades.comparendos com\n " +
" ON com.id_comparendo=p.id_comparendo\n" +
" JOIN utilidades.vehiculos_equipos v ON v.id_vehiculo=com.id_vehiculo\n " +
" JOIN utilidades.conductor c ON c.id_conductor=com.id_conductor\n " +
"\n" +
