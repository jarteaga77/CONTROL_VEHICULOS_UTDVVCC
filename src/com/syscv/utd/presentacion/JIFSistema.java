...
import com.syscv.utd.DaosUtilidades.DaoSistema;
...
public class JIFSistema extends javax.swing.JInternalFrame {
    ...
    public JIFSistema() {
        ...
        try {
            ...
            Logger.getLogger(JIFSistema.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        JD_guardar.setTitle("Registro Sistema");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro Sistema"));
        ...
        JD_Modificar.setTitle("Modificar Sistema");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar Sistema"));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Sistemas"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            sistema.setDescripcion(nom);
            daoSistema.guardar(sistema);
            JOptionPane.showMessageDialog(this, "Se guardo con exito el Sistema");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            sistema.setId(id);
            sistema.setDescripcion(nomrutina);
            
            try {
                daoSistema.actualizar(sistema);
            } catch (Exception ex) {
                Logger.getLogger(JIFSistema.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            
            JOptionPane.showMessageDialog(this, "Se actualizo con exito el sistema");
            LimpiarTabla();
            consultarTodos();
