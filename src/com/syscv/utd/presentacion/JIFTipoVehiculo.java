...
import com.syscv.utd.entidades.DaoTipoVehiculo;
import com.syscv.utd.entidades.TipoVehiculo;
 ...
 * @author Jonathan
 */
public class JIFTipoVehiculo extends javax.swing.JInternalFrame {

    
    private DefaultTableModel modelo;
    private ConexionBD conexion;
    private TipoVehiculo tipo;
    private DaoTipoVehiculo daoTipo;
    
    public JIFTipoVehiculo() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(JIFTipoVehiculo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        JD_guardar.setTitle("Registro Tipo Vehiculo");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registrar Tipo Vehiculo"));
        ...
        JD_Modificar.setTitle("Modificación Tipo Vehiculo");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificación Tipo Vehiculo"));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txt_id1, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Tipo de Vehiculo --UTDVVCC--");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Tipo Vehiculo"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            daoTipo=new DaoTipoVehiculo();
            
            tipo.setDes(nom);
            daoTipo.guardar(tipo);
            JOptionPane.showMessageDialog(this, "Se guardo con exito el Tipo de Vehiculo");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Se actualizo el Tipo de Vehiculos");
            LimpiarTabla();
            consultarTodos();
    ...
    public void consultarTodos() throws SQLException
{
    ...
    ResultSet obj=conexion.executeQuery("SELECT id_tipo_vehi,descripcion FROM utilidades.tipo_vehiculo ORDER BY descripcion ASC");
